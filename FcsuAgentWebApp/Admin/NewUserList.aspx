<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewUserList.aspx.cs" Inherits="FcsuAgentWebApp.Admin.NewUserList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <span class="auto-style1"><strong>All Users:</strong></span><asp:GridView ID="GridViewUsers" 
        runat="server" 
        AllowSorting="True"
