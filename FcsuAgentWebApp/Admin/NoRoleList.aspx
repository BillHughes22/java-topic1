<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NoRoleList.aspx.cs" Inherits="FcsuAgentWebApp.Admin.NoRoleList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
      <span class="auto-style1"><strong>No Role Assigned:</strong></span><asp:GridView ID="GridViewNoRole" 
        runat="server" 
        AllowSorting="True"
        ...
        OnSelectedIndexChanged="GridViewNoRole_RowSelected" OnPageIndexChanging="GridViewNoRole_OnPageIndexChanging"
        DataKeyNames = "UserPk">
