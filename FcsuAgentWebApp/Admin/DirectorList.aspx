<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DirectorList.aspx.cs" Inherits="FcsuAgentWebApp.Admin.DirectorList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <span class="auto-style1"><strong>Directors: </strong></span> <asp:GridView ID="GridViewDirector" 
        runat="server" 
        AllowSorting="True"
        ...
        OnSelectedIndexChanged="GridViewDirector_RowSelected" OnPageIndexChanging="GridViewDirector_OnPageIndexChanging"
        DataKeyNames = "UserPk">
